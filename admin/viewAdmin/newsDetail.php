...
<div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
    <div>
        <h1 class="h3 fw-bold mb-1"><i class="bi bi-file-text text-primary me-2"></i>Article #<?= (int)$news['id'] ?></h1>
        <span class="badge bg-secondary"><?= htmlspecialchars($news['category_name'] ?? 'Uncategorized') ?></span>
        <span class="badge bg-info text-dark ms-1"><i class="bi bi-person me-1"></i><?= htmlspecialchars($news['author'] ?? 'Unknown') ?></span>
    </div>
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow-sm border-0 mb-3">
            <div class="card-header bg-white fw-semibold py-3"><i class="bi bi-image me-2 text-primary"></i>Article Image</div>
        ...
        <!-- Metadata -->
        <div class="card shadow-sm border-0 mb-3">
            <div class="card-header bg-white fw-semibold py-3"><i class="bi bi-info-circle me-2 text-primary"></i>Publication Details</div>
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <span class="text-muted small">Character Count</span>
