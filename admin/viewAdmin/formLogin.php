...
<head>
    ...
    <title>Admin Sign In | NewsPortal</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="container p-3">
        <div class="card login-card mx-auto border-0">
            <div class="card-header bg-dark text-white text-center py-4 border-0">
                ...
                <h4 class="fw-bold mb-0">Admin Sign In</h4>
                <p class="text-secondary small mb-0 mt-1">Sign in to manage news and categories</p>
            </div>
            ...
            <div class="card-body p-4 bg-white">
                ...
                <form action="index.php?action=login" method="POST">
                    <div class="mb-3">
                        <label for="emailInput" class="form-label text-dark fw-semibold small">Email Address</label>
                    ...
                    <div class="mb-4">
                        <label for="passwordInput" class="form-label text-dark fw-semibold small">Password</label>
                        <div class="input-group">
                ...
                <div class="alert alert-light border small text-muted mt-3 mb-0">
                    ...
                    • Administrator: <code>admin@newsportal.ee</code> / <code>123456</code><br>
                    • Regular User: <code>user@newsportal.ee</code> / <code>111111</code>
                </div>
            </div>
        </div>
    </div>
