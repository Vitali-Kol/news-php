        ...
        <form action="index.php?action=registerAnswer" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <span class="input-group-text bg-body-tertiary text-body-secondary"><i class="bi bi-person"></i></span>
            ...
            <div class="mb-3">
                ...
                <div class="form-text text-body-secondary">Email is used for login and must be unique.</div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-body-tertiary text-body-secondary"><i class="bi bi-key"></i></span>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-body-tertiary text-body-secondary"><i class="bi bi-key-fill"></i></span>
