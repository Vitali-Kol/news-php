...
class ViewComments {
        ...
        <div class="card shadow-sm border-0 mb-4 mt-4">
            ...
            <div class="card-body">
                <form action="index.php?action=insertcomment&id=' . $id . '" method="POST">
                    ' . $csrfField . '
                    <div class="mb-3">
                        <label for="commentText" class="form-label text-body-secondary small">Your comment:</label>
    ...
    public static function CommentsByNews($arr) {
        ...
        if (empty($arr)) {
            echo '<div class="alert alert-secondary border text-body-secondary py-3">No comments yet. Be the first to comment!</div>';
        } else {
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2 pb-1 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <strong class="text-body">' . $author . '</strong>
                            </div>
                            <small class="text-body-secondary"><i class="bi bi-clock me-1"></i>' . $date . '</small>
                        </div>
                        <p class="card-text text-body mb-0">' . $text . '</p>
                    </div>
                </div>';
            }
            echo '</div>';
