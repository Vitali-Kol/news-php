...
Веб-приложение новостного портала с полноценной панелью администратора, разработанное на чистом PHP с использованием архитектуры **MVC** (Model-View-Controller) и базы данных MySQL.
...
├── route/
│   └── routing.php            # Маршрутизатор публичной части
├── view/
│   ├── layout.php             # Главный базовый шаблон сайта
