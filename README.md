...
projekt/
├── controller/
│   └── Controller.php     # Контроллер страниц и обработки действий (включая комментарии)
├── inc/
...
│   └── Comments.php       # Модель для работы с комментариями
├── route/
│   └── routing.php        # Маршрутизатор по action (start, allnews, category, read, insertcomment)
├── view/
